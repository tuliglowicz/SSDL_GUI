...
function formAppender(lang,pf){
	var mainContent = "<div id='tabs_" + pf + "' class='ui-tabs ui-widget ui-widget-content ui-corner-all'><ul class='ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all'>"
			...
			+ "<table id='f_emulationTab_vectors_" + pf + "' class='text ui-widget-content ui-corner-all'><thead><tr class='ui-widget-header '><th class='tabField'>"+language[lang].forms.number+"</th><th class='tabField'>"+language[lang].forms.input+"</th><th class='tabField'>"+language[lang].forms.outputs+"</th></tr></thead><tbody><tr></tr></tbody></table></br>"
