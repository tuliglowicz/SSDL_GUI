...
function skeletonAppender(lang,pf){
	var content = "<div id='form_" + pf + "'></div>"
		...
		+ "<div id='f_globalNFPropertiesForm_" + pf + "' title='"+language[lang].mainMenu.nonFunctionalParameters+"'><br><button id='f_globalNFPropertiesForm_changesConfirm_" + pf +"'>"+language[lang].forms.saveChanges+"</button><button id='f_globalNFPropertiesForm_changesCancel_" + pf +"'>"+language[lang].forms.cancel+"</button></div>"
		+ "<div id='f_inputVariablesForm_" + pf + "' title='"+language[lang].mainMenu.inputVariables+"'><br><button id='f_inputVariablesForm_changesConfirm_" + pf +"'>"+language[lang].forms.saveChanges+"</button><button id='f_inputVariablesForm_changesCancel_" + pf +"'>"+language[lang].forms.cancel+"</button></div>"
		+ "<div id='f_graphSaveParamsForm_" + pf + "' title='Graph name & description'><br><button id='f_graphSaveParamsForm_changesConfirm_" + pf +"'>"+language[lang].forms.saveChanges+"</button><button id='f_graphSaveParamsForm_changesCancel_" + pf +"'>"+language[lang].forms.cancel+"</button></div>";
