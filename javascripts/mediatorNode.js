function mediatorNode(cx, cy, name, class_, nodetype, sources, address, description, $nonfunctionality, js_on, subgraph, thisGraph){
	this.super = serv_req;
	...
	this.toString = function(){
		...
		return  "x:"+thisObj.getCoords().cx+", y:"+thisObj.getCoords().cy+"<br/>"+
				...
				"<br/> &nbsp; :serviceName <b>"+js_on.serviceName+
				...
				"</b><br/>nonFunctionalDescription<b>"+js_on.nonFunProp_tab+"</b>";
		else
			return "";
	...
	this.dialogPreperer= function(first){
		...
		.dialog("option", "buttons", [{text: "OK", click: function(){
			//TODO - zmiana nazwy.... 
				...
				thisObj.description = $("#dial1_inp_description")[0].text();
				$(this).dialog("close");}
			},
